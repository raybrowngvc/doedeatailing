jQuery(document).ready(function(){
	...
	function initbackTop() {
	   ...
	   var jQuerybackToTop = jQuery("#backToTop");
	...
	function inViewport(){
		jQuery('.antmate').each(function(){
			var divPos = jQuery(this).offset().top,
	        topOfWindow = jQuery(window).scrollTop();
			 
			if( divPos < topOfWindow+400 ){
				jQuery(this).addClass('animated');
			} else if ( divPos < topOfWindow+600 || divPos > topOfWindow+200) {
	...
	function initProgressBar() {
		if( jQuery(".progress-bar").length != '' ){
			var waypoint = new Waypoint({
				...
				element: document.getElementById('progress-bar01'),
				element: document.getElementById('progress-bar02'),
				element: document.getElementById('progress-bar03'),
				element: document.getElementById('progress-bar04'),
	...
	jQuery('.imhcPinOpener').on('click mouseenter', function(e){
		e.preventDefault();
		jQuery('.imhcPinWrap').removeClass('active');
		jQuery(this).parents('.imhcPinWrap').addClass('active');
	});
});
...
function initSlickCarousel() {
	jQuery('.ibsSlider').slick({
		...
		adaptiveHeight: true,
		autoplaySpeed: 10000,
		prevArrow: '<a href="#" class="slickPrev slickArrowv1 d-flex align-items-center justify-content-center rounded-circle position-absolute"><span class="sr-only">Previous slide</span></a>',
			nextArrow: '<a href="#" class="slickNext slickArrowv1 d-flex align-items-center justify-content-center rounded-circle position-absolute"><span class="sr-only">Next slide</span></a>',
		dots: false,
		autoplay: true,
		responsive: [
			{
	...
	jQuery('.galleryPhotoSlider').slick({
		slidesToShow: 2,
		slidesToScroll: 1,
		arrows: true,
		infinite: false,
	...
	jQuery('.testimonialSliderVI').slick({
		slidesToShow: 3,
		slidesToScroll: 1,
		arrows: false,
		dots: true,
...
// 			jQuery('.mainNavigation .nav-link').parent('li').removeClass('active');
// 			jQuery(this).parent('li').addClass('active');
